"use strict";
import nonColors from "./util/nonColors.ts";
import roundPart from "./util/roundPart.ts";
import webColors from "./util/webColors.ts";
import matchers from "./util/matchers.ts";
import isNonColor from "./util/isNonColor.ts";
import isColorType from "./util/isColorType.ts";
import isOnePointZero from "./util/isOnePointZero.ts";
import isPercentage from "./util/isPercentage.ts";
import isValidCSSUnit from "./util/isValidCSSUnit.ts";
import isColorName from "./util/isColorName.ts";
import bound01 from "./util/bound01.ts";
import boundAlpha from "./util/boundAlpha.ts";
import clamp01 from "./util/clamp01.ts";
import pad2 from "./util/pad2.ts";
import COLOR_FORMAT from "./util/colorFormat.ts";
import getRGBFromName from "./util/getRGBFromName.ts";
import convertHexToDecimal from "./convert/convertHexToDecimal.ts";
import convertDecimalToHex from "./convert/convertDecimalToHex.ts";
import parseIntFromHex from "./convert/parseIntFromHex.ts";
import rgbToHsl from "./convert/rgbToHsl.ts";
import hueToRgb from "./convert/hueToRgb.ts";
import hslToRgb from "./convert/hslToRgb.ts";
import rgbToHwb from "./convert/rgbToHwb.ts";
import hwbToRgb from "./convert/hwbToRgb.ts";
import rgbToHsv from "./convert/rgbToHsv.ts";
import hsvToRgb from "./convert/hsvToRgb.ts";
import rgbToHex from "./convert/rgbToHex.ts";
import rgbaToHex from "./convert/rgbaToHex.ts";
import stringInputToObject from "./util/stringInputToObject.ts";
import inputToRGB from "./util/inputToRgb.ts";

import type ColorFormats from "./util/colorFormats.ts";
import type ColorInputTypes from "./util/colorInputTypes.ts";
import type { RGB } from "./interface/rgb.ts";
import type { RGBA } from "./interface/rgba.ts";
import type { HSL } from "./interface/hsl.ts";
import type { HSLA } from "./interface/hsla.ts";
import type { HSV } from "./interface/hsv.ts";
import type { HSVA } from "./interface/hsva.ts";
import type { HWB } from "./interface/hwb.ts";
import type { HWBA } from "./interface/hwba.ts";
...
import { RGBAObject } from "./interface/rgbaObject.ts";
